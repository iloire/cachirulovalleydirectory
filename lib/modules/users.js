...
exports.VoteUser = function (redis, params, callback){
	function return_data (user_voted, voted, callback){
		exports.GetUser(redis, {id: user_voted.id}, function(err, user_voted){
	...
	if (!params.uservoted || (!params.uservoted.id) || (!params.vote)){
		...
		exports.GetUser(redis, {id: params.uservoted.id}, function(err, user_voted){
			if (!user_voted){
			 	callback('user ' + params.uservoted.id + ' doesn\'t exist!')
			}
			else{
